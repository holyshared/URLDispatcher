...
web build:
 - http://mootools.net/core/649e96492f656fa91fa65dabb2f61c2e

packager build:
 - packager build Core/Core Core/Element.Style Core/Element.Dimensions Core/Fx Core/Request.HTML Core/JSON Core/DOMReady
...
}};var d=function(h){var g=e[h];if(g){g.erase(this);if(!g.length&&c[h]){delete e[h];c[h]=clearInterval(c[h]);}}};})();(function(){var a=Object.prototype.hasOwnProperty;
